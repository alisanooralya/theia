...
export const economyTools = [
  {
    ...
    parameters: {
      ...
      properties: {
        toPhone: {
          type: 'string',
          description: 'Nomor WhatsApp tujuan, contoh: 6281234567890',
        },
        amount: {
          type: 'number',
          description: 'Jumlah uang yang ditransfer (angka bulat positif)',
        },
      },
    ...
    async execute(args, ctx) {
      ...
      if (!Number.isFinite(amount) || amount <= 0) {
        return {
          success: false,
          error: 'Jumlah transfer harus angka bulat positif.',
        };
      }
