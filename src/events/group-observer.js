...
async function sendLinkPreview(sock, jid, text, thumbBuffer, url, title, desc, mentions = []) {
  ...
  try {
    ...
    if (action === 'add') {
      ...
      for (const participant of participants) {
        ...
        await sendLinkPreview(sock, id, caption, image, inviteUrl, groupName, 'Selamat datang di grup!', [jid])
      }
    }
