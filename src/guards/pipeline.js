...
import { checkBotAdmin } from './restrictions/bot-admin.js'
import { checkProblem } from './restrictions/problem-only.js'

const PIPELINE = [
  checkBanned, checkRateLimit, checkCooldown,
  checkOwner, checkPremium, checkGroup, checkPrivate, checkAdmin, checkBotAdmin, checkProblem,
]
